...
/**
 * 排序算法主类
 * 八种基本排序：插入排序、选择排序、冒泡排序、希尔排序、堆排序、快速排序、归并排序、基数排序 
...
public class SortArray {
	...
	public void testSortArray1() {
		long currentTimeMillis = MyTimeStampUtils.getNanoTime();
		for(int i = 0;i<10000;i++){
			int[] arr = { 32, 43, 56, 12, 34, 21, 34, 54, 19 };
			SortArray.insertSort(arr);// 插入排序
		}
		System.out.println("插入排序: " + (MyTimeStampUtils.getNanoTime()-currentTimeMillis));
	}
	@Test
	public void testSortArray2() {
		...
		for(int i = 0;i<10000;i++){
			int[] arr = { 32, 43, 56, 12, 34, 21, 34, 54, 19 };
			SortArray.selectSort(arr); // 选择排序
		}
		System.out.println("选择排序: " + (MyTimeStampUtils.getNanoTime()-currentTimeMillis));
	}
	@Test
	public void testSortArray3() {
		...
		for(int i = 0;i<10000;i++){
			int[] arr = { 32, 43, 56, 12, 34, 21, 34, 54, 19 };
			SortArray.bubbleSort(arr); // 冒泡排序9576429
		}
		System.out.println("冒泡排序: " + (MyTimeStampUtils.getNanoTime()-currentTimeMillis));
	}
	@Test
	public void testSortArray4() {
		...
		for(int i = 0;i<10000;i++){
			int[] arr = { 32, 43, 56, 12, 34, 21, 34, 54, 19 };
			SortArray.shellSort(arr); // 希尔排序
		}
		System.out.println("希尔排序: " + (MyTimeStampUtils.getNanoTime()-currentTimeMillis));
	}
	@Test
	public void testSortArray5() {
		...
		for(int i = 0;i<10000;i++){
			int[] arr = { 32, 43, 56, 12, 34, 21, 34, 54, 19 };
			SortArray.heapSort(arr); // 堆排序
		}
		System.out.println("堆排序: " + (MyTimeStampUtils.getNanoTime()-currentTimeMillis));
	}
	@Test
	public void testSortArray6() {
		...
		for(int i = 0;i<10000;i++){
			int[] arr = { 32, 43, 56, 12, 34, 21, 34, 54, 19 };
			SortArray.quickSort(arr); // 快速排序
			// sa.mergingSort(arr, 0, arr.length - 1 ); // 归并排序
		}
		System.out.println("快速排序: " + (MyTimeStampUtils.getNanoTime()-currentTimeMillis));
	}
	@Test
	public void testSortArray8() {
		...
		for(int i = 0;i<10000;i++){
			int[] arr = { 32, 43, 56, 12, 34, 21, 34, 54, 19 };
			SortArray.radixSort(arr); // 基数排序
		}
		System.out.println("基数排序: " + (MyTimeStampUtils.getNanoTime()-currentTimeMillis));
	}
